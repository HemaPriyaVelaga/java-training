...
public class LinkedHashMapDao implements ContactsDao{
    ...
    public LinkedHashMapDao()
    {
        ...
        try {
            list.put(1, new Contact(1,"Kavitha", "Velaga", Gender.FEMALE,"kavitha@gmail.com", "9866366566", "Siripuram", "Guntur", "Andhra Pradesh", 111111, "India", sdf.parse("14/11/1974") ));
            list.put(2, new Contact(2,"Venu", "Velaga", Gender.MALE,"venuv@gmail.com", "9866366966", "Tenali", "Guntur", "Andhra Pradesh", 222222, "India", sdf.parse("27/05/1968") ));
            list.put(3, new Contact(3,"Hema", "Priya", Gender.FEMALE,"hemapriya@gmail.com", "8500903254", "Kukatpally", "Hyderabad", "Telangana", 500072, "India", sdf.parse("20/11/1997") ));
            list.put(4, new Contact(4,"Hima", "Bindu", Gender.FEMALE,"himabindu@gmail.com", "8519848992", "KPHB", "Hyderabad", "Telangana", 500072, "India", sdf.parse("21/02/2005") ));
    ...
    public void deleteContact(int id) throws DaoException {
        ...
        try {
            ...
            Contact cont = values.stream()
                    ...
                    .findAny()
                    .orElse(null);
            if(cont!=null && list.containsKey(cont.getId()))

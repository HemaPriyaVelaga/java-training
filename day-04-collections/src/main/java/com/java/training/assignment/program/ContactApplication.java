package com.java.training.assignment.program;

import com.java.training.assignment.entity.*;
import com.java.training.assignment.utils.KeyboardUtil;
...
public class ContactApplication {
    ...
    public static void main(String[] args) {
        ...
        new ContactApplication().start();

    }

    void start()
    {
        daolist = new ArrayListContactsDao();
        int choice;
    ...
    {
        line('=');
        System.out.printf("%10s %15s %15s %15s %20s %15s %15s %15s %15s %15s %15s %15s\n", "ID", "First Name", "Last Name", "Gender",

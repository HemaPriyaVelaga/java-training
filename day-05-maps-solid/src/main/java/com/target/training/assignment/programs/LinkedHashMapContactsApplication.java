package com.target.training.assignment.programs;

import com.target.training.assignment.entities.*;
import com.target.training.utils.KeyboardUtil;

import java.util.Date;
import java.util.List;

public class LinkedHashMapContactsApplication {
    ContactsDao daolist;

    public static void main(String[] args) {

        new LinkedHashMapContactsApplication().start();

    }

    void start()
    {
        daolist = new LinkedHashMapDao();
        int choice;
